...
local Window = Library.CreateLib("Thief Simulator Synex#3630", "Ocean")
...
MainSection:NewButton("Auto Rob NPC", "Auto Robs NPCS", function()
...
MainSection:NewButton("infinite field", "Executes An FE Admin Script", function()
...
OtherSection:NewSlider("WalkSpeed", "Changes The WalkSpeed", 500, 16, function(s) 
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = s
end)

OtherSection:NewSlider("JumpPower", "Changes The JumpPower", 350, 50, function(s) 
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = s
end)

OtherSection:NewButton("Reset WalkSpeed Jump Power", "Reset WalkSpeed And JumpPower To Normal", function()
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 16
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = 50
end)

OtherSection:NewButton("Teleport Tool", "Gives You A Teleport Tool", function()
